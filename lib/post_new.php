    ...
    <div class="card" id="post-new-card">
        <div class="padding-post-new-page">
            ...
            <div class="row bs-wizard" style="border-bottom:0;">
                ...
                <div
                    class="col-3 col-sm-3 bs-wizard-step <?php if($new_Project_step > 1) echo 'complete'; elseif($new_Project_step == 1) echo 'active'; else echo 'disabled'; ?>  ">
                    <div class="text-center bs-wizard-stepnum">
                        <?php echo __("Purchase Request Details", 'ProjectTheme') ?> </div>
                    <div class="progress">
                ...
                <div
                    class="col-3 col-sm-3 bs-wizard-step  <?php if($new_Project_step > 2) echo 'complete'; elseif($new_Project_step == 2) echo 'active'; else echo 'disabled'; ?> ">
                    <!-- complete -->
                ...
                <div
                    class="col-3 col-sm-3 bs-wizard-step <?php if($new_Project_step > 3) echo 'complete'; elseif($new_Project_step == 3) echo 'active'; else echo 'disabled'; ?>  ">
                    <!-- complete -->
                ...
                <div
                    class="col-3 col-sm-3 bs-wizard-step <?php if($new_Project_step > 4) echo 'complete'; elseif($new_Project_step == 4) echo 'active'; else echo 'disabled'; ?>  ">
                    <!-- active -->
	...
	?>
                ...
                <form method="post" action="<?php echo ProjectTheme_post_new_with_pid_stuff_thg($pid, '1');?>">
                    <ul class="post-new">
                        ...
                        <li class="<?php echo projecttheme_get_post_new_error_thing('project_title') ?>">
                            ...
                            <h2><?php echo __('Title', 'ProjectTheme'); ?></h2>
                            <p><input type="text" size="50" class="form-control" name="project_title"
                                    placeholder="<?php _e('Puchase of cement for concreting of pathway to Purok 1','ProjectTheme') ?>"
		...
		?>
                        <li class="<?php echo projecttheme_get_post_new_error_thing('project_description') ?>">
                            ...
                            <p><textarea rows="6" cols="60" class="form-control"
                                    placeholder="<?php _e('Describe here your project scope.','ProjectTheme') ?>"
                                    name="project_description"><?php echo trim($pst); ?></textarea></p>
                        </li>
                        ...
                        <li class="<?php echo projecttheme_get_post_new_error_thing('project_category') ?>">
                            ...
                            function display_subcat(vals) {
                                jQuery.post("<?php echo esc_url( home_url() ) ; ?>/?get_subcats_for_me=1", {
                                    queryString: "" + vals + ""
                                }, function(data) {
                                    if (data.length > 0) {
                            ...
                            function display_subcat2(vals) {
                                jQuery.post("<?php echo esc_url( home_url() )  ?>/?get_locscats_for_me=1", {
                                    queryString: "" + vals + ""
                                }, function(data) {
                                    if (data.length > 0) {
                            ...
                            function display_subcat3(vals) {
                                jQuery.post("<?php echo esc_url( home_url() )  ?>/?get_locscats_for_me2=1", {
                                    queryString: "" + vals + ""
                                }, function(data) {
                                    if (data.length > 0) {
		...
		?>
                        <li>
                            ...
                            <p><input type="text" size="50" class="form-control" name="project_tags"
                                    placeholder="<?php _e('eg: something, comma, separated.','ProjectTheme') ?>"
                                    value="<?php echo $project_tags; ?>" /> </p>
                        </li>
                        ...
                        <!-- <li style="margin-bottom:25px;">
                            ...
                            <link rel="stylesheet"
                                href="<?php echo get_template_directory_uri(); ?>/textdropdown/css/textext.plugin.arrow.css"
                                type="text/css" />
                            <script src="<?php echo get_template_directory_uri(); ?>/textdropdown/js/textext.core.js"
                            ...
                            <link rel="stylesheet"
                                href="<?php echo get_template_directory_uri(); ?>/textdropdown/css/textext.core.css"
                                type="text/css" />
                            <link rel="stylesheet"
                                href="<?php echo get_template_directory_uri(); ?>/textdropdown/css/textext.plugin.tags.css"
                                type="text/css" />
                            <link rel="stylesheet"
                                href="<?php echo get_template_directory_uri(); ?>/textdropdown/css/textext.plugin.autocomplete.css"
                                type="text/css" />
                            <link rel="stylesheet"
                                href="<?php echo get_template_directory_uri(); ?>/textdropdown/css/textext.plugin.focus.css"
                                type="text/css" />
                            <link rel="stylesheet"
                                href="<?php echo get_template_directory_uri(); ?>/textdropdown/css/textext.plugin.prompt.css"
                                type="text/css" />
                            <link rel="stylesheet"
                                href="<?php echo get_template_directory_uri(); ?>/textdropdown/css/textext.plugin.arrow.css"
                                type="text/css" />
                            <script src="<?php echo get_template_directory_uri(); ?>/textdropdown/js/textext.core.js"
                                type="text/javascript" charset="utf-8"></script>
                            <script
                                src="<?php echo get_template_directory_uri(); ?>/textdropdown/js/textext.plugin.tags.js"
                                type="text/javascript" charset="utf-8"></script>
                            <script
                                src="<?php echo get_template_directory_uri(); ?>/textdropdown/js/textext.plugin.autocomplete.js"
                                type="text/javascript" charset="utf-8"></script>
                            <script
                                src="<?php echo get_template_directory_uri(); ?>/textdropdown/js/textext.plugin.suggestions.js"
                                type="text/javascript" charset="utf-8"></script>
                            <script
                                src="<?php echo get_template_directory_uri(); ?>/textdropdown/js/textext.plugin.filter.js"
                                type="text/javascript" charset="utf-8"></script>
                            <script
                                src="<?php echo get_template_directory_uri(); ?>/textdropdown/js/textext.plugin.focus.js"
                                type="text/javascript" charset="utf-8"></script>
                            <script
                                src="<?php echo get_template_directory_uri(); ?>/textdropdown/js/textext.plugin.prompt.js"
                                type="text/javascript" charset="utf-8"></script>
                            <script
                                src="<?php echo get_template_directory_uri(); ?>/textdropdown/js/textext.plugin.ajax.js"
                                type="text/javascript" charset="utf-8"></script>
                            <script
                                src="<?php echo get_template_directory_uri(); ?>/textdropdown/js/textext.plugin.arrow.js"
                                type="text/javascript" charset="utf-8"></script>
...
?>
                            ...
                            <div style="width: 100%;" id="x1cs">
                                <input type="text" style="width: 200px; height: 55px" id="skills_me"
                                    name="skills_thing" />
                        ...
                        <li class="<?php echo projecttheme_get_post_new_error_thing('project_price') ?>">
                            ...
                            <h2><?php echo __('Budget', 'ProjectTheme'); ?></h2>
                            <p class="strom_100">
			...
			if($type == "input_box")
			{
					...
					?>
                                ...
                                <input type="number" required size="50" class="form-control" name="budgets"
                                    placeholder="<?php echo ProjectTheme_get_currency() ?>"
                                    value="<?php echo $sel; ?>" />
	  ...
	  ?>
                        ...
                        <li class="images-files-li">
                            <h2>
                                ...
                                <link rel="stylesheet" media="all" type="text/css"
                                    href="<?php echo get_template_directory_uri(); ?>/css/ui_thing.css" />
                                <script type="text/javascript" language="javascript"
                                    src="<?php echo get_template_directory_uri(); ?>/js/timepicker.js"></script>


                                <?php _e("Project Deadline",'ProjectTheme'); ?>
                            </h2>
                            <?php
	   ...
	   ?>
                            <p><input type="text" name="ending1" id="ending" required class="form-control"
                                    autocomplete="off" value="<?php echo $dt; ?>" /></p>
                        </li>
	   ...
	   ?>
                        <li>
                            ...
                            <p><input type="text" size="50" class="form-control"
                                    placeholder="<?php _e('eg: New York, 13221','ProjectTheme'); ?>"
                                    name="project_location_addr" id="project_location_addr" value="<?php echo !isset($_POST['project_location_addr']) ?
		get_post_meta($pid, 'Location', true) : $_POST['project_location_addr']; ?>" /> </p>
                        </li>


                        <input type="hidden" size="35" name="project_lat" id="lat"
                            value="<?php echo get_post_meta($pid, 'project_lat', true); ?>" class="form-control" />
                        <input type="hidden" size="35" name="project_lon" id="lon"
                            value="<?php echo get_post_meta($pid, 'project_lon', true); ?>" class="form-control" />
                        ...
                        function initAutocomplete() {
                            ...
                            autocomplete = new google.maps.places.Autocomplete(
                                ...
                                (document.getElementById('project_location_addr')), {
                                    types: ['geocode']
                                });
                        ...
                        <script
                            src="https://maps.googleapis.com/maps/api/js?signed_in=true&libraries=places&callback=initAutocomplete&key=<?php echo get_option('ProjectTheme_radius_maps_api_key') ?>"
                            async defer></script>
                        ...
                        <li class="images-files-li">
                            <h2><?php _e('Attach Images','ProjectTheme'); ?></h2>
                            <div class="cross_cross">
                                ...
                                <script type="text/javascript"
                                    src="<?php echo get_template_directory_uri(); ?>/js/dropzone.js"></script>
                                <link rel="stylesheet"
                                    href="<?php echo get_template_directory_uri(); ?>/css/dropzone.css"
                                    type="text/css" />
			...
			$url = wp_get_attachment_url($attachment->ID);
				...
				?>
                                    ...
                                    myDropzone.options.thumbnail.call(myDropzone, mockFile,
                                        "<?php echo projectTheme_generate_thumb($attachment->ID, 100, 100) ?>"
                                    );
	...
	?>
                                    ...
                                    myDropzone.on("success", function(file, response) {
                                        ...
                                        file.thumbnail =
                                            "<?php echo get_template_directory_uri() ?>/images/file_icon.png";
                        ...
                        <li>
                            ...
                            <p>
                                <input type="submit" name="project_submit1"
                                    value="<?php _e("Next Step", 'ProjectTheme'); ?> >>" class="btn btn-primary"
                                    role="button" />
                            </p>
                        </li>
...
if($new_Project_step == "2")
{
	...
	?>
		...
		?>
                        <p><a href="<?php echo ProjectTheme_post_new_with_pid_stuff_thg($pid, $stp); ?>"
                                class="btn btn-primary" role="button"><?php _e('Go Back','ProjectTheme'); ?></a>
                            <input type="submit" name="project_submit2"
                                value="<?php _e("Next Step", 'ProjectTheme'); ?> >>" class="btn btn-primary"
                                role="button" />
                        </p>
                    </li>
...
?>
            ...
            <div class="padd10">
                ...
                <a href="<?php echo ProjectTheme_post_new_with_pid_stuff_thg($pid, 2); ?>" class="btn btn-primary"
                    role="button"><?php _e('Go Back','ProjectTheme'); ?></a>
                <a href="<?php echo ProjectTheme_post_new_with_pid_stuff_thg($pid, 4); ?>" class="btn btn-primary"
                    role="button"><?php _e('Next Step','ProjectTheme'); ?> >></a>
...
?>
            ...
            jQuery(document).ready(function() {
                ...
                jQuery('.get_files').click(function() {
                    ...
                    jQuery.colorbox({
                        href: "<?php echo esc_url( home_url() )  ?>/?get_files_panel=" + myRel[
                            0] + "&uid=" + myRel[1]
                    });
                    return false;
                });
...
?>
 ...
 ?>
                                ...
                                <div class="padd10">
                                    ...
                                    <div class="small_buttons_div_left p-3">
                                        ...
                                        <div class="container" id="project-details-id">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 column-details-1"><img
                                                        src="<?php echo get_template_directory_uri() ?>/images/wallet_icon2.png"
                                                        width="18" height="18" alt="budget" />
                                                    <?php echo __("Project Budget",'ProjectTheme'); ?> </div>
                                                <div class="col-md-8 column-details-2">
                                                    <?php echo ProjectTheme_get_budget_name_string_fromID(get_post_meta($PID_PID, 'budgets', true)); ?>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 column-details-1"><img
                                                        src="<?php echo get_template_directory_uri() ?>/images/coins_icon.png"
                                                        width="18" height="18" alt="coins" />
                                                    <?php echo __("Average Bid",'ProjectTheme'); ?> </div>
                                                <div class="col-md-8 column-details-2">
                                                    <?php echo ProjectTheme_average_bid($PID_PID); ?></div>
                                            </div>
						...
						?>
                                            <div class="row">
                                                <div class="col-md-4 column-details-1"><img
                                                        src="<?php echo get_template_directory_uri(); ?>/images/loc_icon.png"
                                                        width="18" height="18" alt="location" />
                                                    <?php echo __("Location",'ProjectTheme'); ?> </div>
                                                <div class="col-md-8 column-details-2">
                                                    <?php echo get_the_term_list( $PID_PID, 'project_location', '', ', ', '' ); ?>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 column-details-1"><img
                                                        src="<?php echo get_template_directory_uri(); ?>/images/cate_icon.png"
                                                        width="18" height="18" alt="category" />
                                                    <?php echo __("Category",'ProjectTheme'); ?></div>
                                                <div class="col-md-8 column-details-2">
                                                    <?php echo get_the_term_list( $PID_PID, 'project_cat', '', ', ', '' ); ?>
                                                </div>
                                            </div>
			...
			?></div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 column-details-1"><img
                                                        src="<?php echo get_template_directory_uri(); ?>/images/cal_icon.png"
                                                        width="18" height="18" alt="calendar" />
                                                    <?php echo __("Posted on",'ProjectTheme'); ?> </div>
                                                <div class="col-md-8 column-details-2">
                                                    <?php echo get_the_time("jS F Y g:i A", $PID_PID); ?></div>
                                            </div>

                                            <div class="row">
                                                <div class="col-md-4 column-details-1"><img
                                                        src="<?php echo get_template_directory_uri(); ?>/images/clock_icon.png"
                                                        width="18" height="18" alt="clock" />
                                                    <?php echo __("Project Deadline",'ProjectTheme'); ?></div>
                                                <div class="col-md-8 column-details-2">
                                                    <?php echo date_i18n("d-M-Y",get_post_meta($PID_PID, 'deadline', true)); ?>
                                                </div>
                                            </div>
								...
								: __("Expired/Closed",'ProjectTheme')); ?>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 column-details-1"> <img
                                                        src="<?php echo get_template_directory_uri() ?>/images/prop_icon.png"
                                                        width="18" height="18" alt="proposals" />
                                                    <?php echo __("Proposals",'ProjectTheme'); ?></div>
                                                <div class="col-md-8 column-details-2">
                                                    <?php echo projectTheme_number_of_bid($PID_PID); ?></div>
                                            </div>
		...
		?>
                    ...
                    <div class="card">
                        ...
                        <div class="box_content">
                            ...
                            <script type="text/javascript"
                                src="https://maps.google.com/maps/api/js?sensor=false&key=<?php echo get_option('ProjectTheme_radius_maps_api_key') ?>">
                            </script>

                            <script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/js/mk.js">
                            </script>
                            <script type="text/javascript">
                            var geocoder;
                            var map;
	...
	?>
                    ...
                    <li class="widget-container widget_text" id="ad-other-details">
                        ...
                        <div class="row">
                            ...
                            <div class=" col-md-12 text-center mt-4 "><img width="150" height="150" border="0"
                                    class="project-single-avatar rounded-circle"
                                    src="<?php echo ProjectTheme_get_avatar($post_AU->post_author, 160, 160); ?>" />
                            </div>


                            <div class=" col-md-12 text-center mt-4 mb-3"><a class="avatar-posted-by-username"
                                    href="<?php echo home_url(); ?>/?p_action=user_profile&post_author=<?php echo $post_AU->post_author; ?>">
                                    <h5><?php echo $current_user->user_login; ?></h5>
                                </a></div>
                            <div class=" col-md-12 text-center">
                                <?php echo ProjectTheme_project_get_star_rating2($post_AU->post_author); ?></div>
                            <div class=" col-md-12 text-center"><a
                                    href="<?php echo ProjectTheme_get_user_feedback_link($post_AU->post_author); ?>"><?php _e('View User Feedback','ProjectTheme'); ?></a>
                            </div>
		...
		?>
                        ...
                        <div class="d-flex  mb-0">
                            <div class="mr-auto p-2"><i class="fas fa-folder"></i>
                                <?php _e("Has created:",'ProjectTheme');?></div>
                            <div class="p-2 "><?php echo sprintf(__("%s project(s)",'ProjectTheme'), $has_created); ?>
                            </div>
                        </div>


                        <div class="d-flex  mb-0">
                            <div class="mr-auto p-2"><i class="far fa-window-close"></i>
                                <?php _e("Has closed:",'ProjectTheme');?></div>
                            <div class="p-2 "><?php echo sprintf(__("%s project(s)",'ProjectTheme'), $has_closed); ?>
                            </div>
                        </div>


                        <div class="d-flex  mb-0">
                            <div class="mr-auto p-2"><i class="fas fa-certificate"></i>
                                <?php _e("Has rated:",'ProjectTheme');?></div>
                            <div class="p-2 "><?php echo sprintf(__("%s provider(s)",'ProjectTheme'), $has_rated); ?>
                            </div>
                        </div>
                        ...
                        <br /><br />
                        <a href="<?php echo home_url(); ?>/?p_action=user_profile&post_author=<?php echo $post_AU->post_author; ?>"
                            class="btn btn-secondary btn-sm btn-block"><?php _e('See More Projects by this user','ProjectTheme'); ?></a><br />
				...
				?>
                            ...
                            <li> <a
                                    href="<?php echo wp_get_attachment_url($at->ID); ?>"><?php echo $at->post_title; ?></a>
                            </li>
                            <?php }   ?>
                        </ul>
                        </p>
                    ...
                    <li class="widget-container widget_text" id="ad-other-details">
                        ...
                        <div class="add-this">
                            ...
                            <script type="text/javascript"
                                src="http://s7.addthis.com/js/250/addthis_widget.js#pubid=xa-4df68b4a2795dcd9"></script>
                            <!-- AddThis Button END -->
                        </div>
		...
		?>
                            <li>
                                <img src="<?php echo get_template_directory_uri(); ?>/images/location.png" width="15"
                                    height="15" />
				...
				?>
                            ...
                            <li>
                                <img src="<?php echo get_template_directory_uri(); ?>/images/viewed.png" width="15"
                                    height="15" />
