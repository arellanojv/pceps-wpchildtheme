		...
		<div id="main" class="wrapper-register">
				...
				<h3 class="h3-name"><?php printf(__("Register",'ProjectTheme')); ?></h3>
						  ...
						  <input type="hidden" name="action" value="register" />
							...
							<input type="radio" class="do_input_radio" name="user_tp" id="user_tp" value="Temp_service_provider" checked="checked" /> <?php _e('Vendor (Service Provider)','ProjectTheme'); ?><br/>
                            <input type="radio" class="do_input_radio" name="user_tp" id="user_tp" value="Temp_service_buyer" /> <?php _e('End user (Customer)','ProjectTheme'); ?><br/>
							</p>
