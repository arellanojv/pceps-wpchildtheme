 ...
 <div class="page_heading_me_project pt_template_page_1 " id="pt_template_page_1">
 								...
 								<div class="row">
                                  ...
                                  <?php
                                   ...
                                   ?>
                                  <h5><?php echo sprintf(__('Your account was pre-activated. You can <a href="%s">login here</a>', 'ProjectTheme'), get_site_url() . "/wp-login.php") .' to fully activate your account.' ?></h5>
